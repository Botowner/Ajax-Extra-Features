...
async def next_page(bot, query):
    ...
    if int(req) not in [query.from_user.id, 0]:
        return await query.answer("😁 ᴇᴅᴀ ᴍᴡᴏɴᴇ  ᴀᴛʜ ʟᴏᴄᴋᴀᴀ 🔐.", show_alert=True)
    try:
        offset = int(offset)
    except:
        offset = 0
    ...
    if n_offset == 0:
        ...
        btn.append(
            [
             InlineKeyboardButton("ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴄʜᴇᴄᴋ ᴜʀ ғɪʟᴇ", url=f"https://t.me/ccomfilterbot")]
        )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('𝙽𝙴𝚇𝚃', callback_data='fun')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text="▣ ▢ ▢"
        ...
        buttons = [[    
            ...
            InlineKeyboardButton('𝙽𝙴𝚇𝚃', callback_data='report')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text="▣ ▢ ▢"
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⚚ 𝙱𝙰𝙲𝙺 ⚚', callback_data='report')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text="▣ ▢ ▢"
        ...
        buttons= [[
            InlineKeyboardButton(' ʙᴏᴛ ᴏᴡɴᴇʀ ', url='https://t.me/Aswin_pm_Bot')
            ],[
