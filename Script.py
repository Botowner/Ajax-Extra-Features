...
║┣⪼❈ ᴅᴀᴛᴀ ʙᴀsᴇ :  ᴍᴏɴɢᴏ ᴅʙ
║┣⪼❈ ʙᴏᴛ sᴇʀᴠᴇʀ :  ʜᴇʀᴜᴋᴏ
║┣⪼❈ ʙᴜɪʟᴅ sᴛᴀᴛᴜs :  ᴠ2.0.1[ʙᴇᴛᴀ]
╰•━━━━━━━━━━━━━━━➣"""
    DONATION_TXT = """<b>𝐃𝐨𝐧𝐚𝐭𝐢𝐨𝐧 & 𝐏𝐚𝐢𝐝 𝐏𝐫𝐨𝐦𝐨𝐭𝐢𝐨𝐧</b> 

›› <b>𝐃𝐨𝐧𝐚𝐭𝐢𝐨𝐧</b>

⪼ <b>𝐘𝐨𝐮 𝐂𝐚𝐧 𝐃𝐨𝐧𝐚𝐭𝐞 𝐀𝐧𝐲 𝐀𝐦𝐨𝐮𝐧𝐭 𝐘𝐨𝐮 𝐇𝐚𝐯𝐞 💳 (ɴᴏᴛ ᴄᴏᴍᴘᴜʟsᴏʀʏ). 
<b>━━━━━━━━━᚜ Payment Methods ᚛━━━━━━━━━
✮ 𝗚𝗼𝗼𝗴𝗹𝗲𝗣𝗮𝘆
✮ 𝗣𝗮𝘆𝘁𝗺
_𝐂𝐨𝐧𝐭𝐚𝐜𝐭 𝐌𝐞 𝐅𝐨𝐫 𝐊𝐧𝐨𝐰 𝐀𝐛𝐨𝐮𝐭 𝐓𝐡𝐞 𝐏𝐚𝐲𝐦𝐞𝐧𝐭 𝐈𝐧𝐟𝐨_
━━━━━━━━━━━━᚜ <a href=https://t.me/Aswin_pm_Bot>ᴀꜱᴡɪɴ</a> ᚛━━━━━━━━━━━━
...
5. /luck or /cownd - 𝚂𝙿𝙸𝙽 𝙰𝙽𝙳 𝚃𝚁𝚈 𝚈𝙾𝚄𝚁 𝙻𝚄𝙲𝙺"""
    DEPLOY_TXT = """ 🧐 <b>Any doubt connect me</b>

𝙸𝙵 𝚈𝙾𝚄 𝚆𝙰𝙽𝚃 𝚃𝙷𝙴 ᵤₗQᵤₑᵣ ₂.₀ 𝚁𝙴𝙿𝙾 𝙲𝙾𝙽𝚃𝙰𝙲𝚃 <a href=https://t.me/Aswin_pm_Bot>ᴀꜱᴡɪɴ</a>
"""
    MANUELFILTER_TXT = """Help: <b>Filters</b>

- Filter is the feature were users can set automated replies for a particular keyword and DᵤₗQᵤₑᵣ ₂.₀  will respond whenever a keyword is found the message

<b>NOTE:</b>
1. DᵤₗQᵤₑᵣ ₂.₀ should have admin privillage.
...
• This Command Can be used by everyone"""
    ...
    PRIVATEBOT_TXT = """<b>Tʜɪs ʙᴏᴛ ғᴏʀ ᴍᴇ ᴏɴʟʏ</b>"""
...
-DᵤₗQᵤₑᵣ ₂.₀  Supports both url and alert inline buttons.

<b>NOTE:</b>
1. Telegram will not allows you to send buttons without any content, so content is mandatory.
2. DᵤₗQᵤₑᵣ ₂.₀ supports buttons with any telegram media type.
3. Buttons should be properly parsed as markdown format

<b>URL buttons:</b>
<code>[Button Text](buttonurl:https://t.me/cinemala_com1)</code>
...
<b>NOTE:</b>
these are the extra features of DᵤₗQᵤₑᵣ ₂.₀ 
...
⚠️ 𝙳𝚄𝙴 𝚃𝙾 𝙲𝙾𝙿𝚈𝚁𝙸𝙶𝙷𝚃 𝙸𝚂𝚂𝚄𝙴 𝙵𝙸𝙻𝚃𝙴𝚁𝚂 𝚆𝙸𝙻𝙻 𝙱𝙴 𝙳𝙴𝙻𝙴𝚃𝙴𝙳 𝙸𝙽 10 𝙼𝙸𝙽⏱️.
© ᴄɪɴᴇᴍᴀʟᴀ.ᴄᴏᴍ </b>"""
